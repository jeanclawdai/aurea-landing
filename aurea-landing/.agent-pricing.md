...
## Task: Redesign Pricing.tsx to match rvmp.me card style

Working dir: /Users/jeanclawd/.openclaw/workspace/aurea-landing

Reference card design from rvmp.me:
- Light gray card background (bg-gray-100), no border
- Big rounded corners (rounded-3xl), lots of padding (p-10)
- Pill badge at top: e.g. "14-day free trial"
- Bold plan name headline with serif italic accent
- Green price color (#16a34a / text-green-600)
- Full-width BLACK rounded-full CTA button at bottom
- Two-column section at bottom: "What's included" | "What you get"
- Popular plan: dark bg (bg-gray-950) with same structure

## Rewrite Pricing.tsx completely:
...
If clean, run: git add -A && git commit -m "feat: pricing cards — rvmp.me style, green price, rounded-full CTA, two-column breakdown"
Then: openclaw system event --text "Done: Pricing redesign complete — rvmp.me card style" --mode now
