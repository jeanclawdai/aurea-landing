    ...
    <div className="grid grid-cols-3 gap-4 h-full">
      ...
      <div className="col-span-2 row-span-2 bg-white dark:bg-[#1a1a28] rounded-2xl p-5 shadow-md border border-gray-100 dark:border-white/10">
        ...
        <div className="flex items-center gap-4 mb-5">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-300 to-pink-400 flex items-center justify-center text-white font-bold text-xl shadow-md">A</div>
          <div>
