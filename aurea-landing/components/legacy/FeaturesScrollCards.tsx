  ...
  return (
    <section id="features" className="py-24 px-6 overflow-hidden bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-6 bg-white border border-gray-200 text-gray-500">{lang === "pt" ? "O QUE FAZEMOS" : "WHAT WE DO"}</span>
