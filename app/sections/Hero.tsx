  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <form onSubmit={handleAudit} className="flex flex-col sm:flex-row gap-3 w-full max-w-xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-shimmer group flex items-center justify-center gap-2 px-7 py-3.5 bg-gray-900 text-white rounded-xl font-semibold text-base shadow-lg hover:bg-gray-800 transition-all whitespace-nowrap"
            >
              {t.hero.cta2.replace(" →", "")}
        ...
        {/* PLACEHOLDER: App preview / dashboard mockup */}
        <div className="relative max-w-3xl mx-auto mb-16 hidden lg:block">
          <div className="w-full h-[280px] rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-transparent" />
            <div className="text-center relative z-10">
              <div className="text-white/30 text-sm font-mono mb-2">[ PLACEHOLDER ]</div>
              <div className="text-white/60 text-lg font-medium">App Dashboard Preview</div>
              <div className="text-white/30 text-xs mt-1">Replace with product screenshot or mockup</div>
            </div>
        ...
        >
          {featureCards.map((card, i) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              whileHover={{ y: -4, boxShadow: "0 12px 40px rgba(111,168,255,0.15)" }}
              transition={{ duration: 0.5, delay: 0.7 + i * 0.08, type: "spring", stiffness: 300, damping: 20 }}
